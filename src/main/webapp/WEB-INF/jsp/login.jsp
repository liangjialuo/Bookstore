...
<div id="top_div">
    ...
    <p class="right"><a>登陆</a> | <a href="register">注册</a> | <a href="shoppingCar">我的购物车</a> | <a
            href="index">网站首页</a></p>
    <div class="fixed"></div>
</div>
            ...
            <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="56%" align="left" valign="middle">
                        <input type="text" name="" value="" class="input w180">
                    </td>
                </tr>
            </table>
            <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="56%" align="left" valign="middle">
                        <input type="password" name="" value="" class="input w180">
                    </td>
                </tr>
            </table>
