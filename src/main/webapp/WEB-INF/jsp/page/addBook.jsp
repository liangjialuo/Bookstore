...
<div class="w960">
    ...
    <div class="w740 right">
        ...
        <div class="order02 pb10">
            <f:form action="book/insertBook" method="post" modelAttribute="book" enctype="multipart/form-data">
                <table width="738" align="center" cellpadding="0" cellspacing="0">
                    <tr class="bd2">
                        ...
                        <td width="80%" align="left" class="bd1 pl9">
                            <f:input path="bookname" class="input w300"/><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        ...
                        <td width="80%" align="left" class="bd1 pl9">
                            <f:select path="booktypeid" style="width:300px;">
                                <option value="">--请选择--</option>
                                <option value="1">文艺</option>
                                <option value="2">小说</option>
                                <option value="3">青春</option>
                            </f:select><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        ...
                        <td width="80%" align="left" class="bd1 pl9">
                            <f:input path="bookauthor" class="input w300"/><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        ...
                        <td width="80%" align="left" class="bd1 pl9">
                            <f:input path="bookprice" class="input w300"/><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        <th width="20%" align="center" class="bd2">库存
                        </td>
                        <td width="80%" align="left" class="bd1 pl9">
                            <f:input path="bookinventory" class="input w300"/><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        ...
                        <td width="80%" align="left" class="bd1 pl9">
                            <f:input path="bookconcern" class="input w300"/><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        <th width="20%" align="center" class="bd2">封面</th>
                        </td>
                        <td width="80%" align="left" class="bd1 pl9">
                            <input type="file" name="bookimage" class="input w300"/><span class="required">*</span>
                        </td>
                    </tr>
                    <tr class="bd2">
                        ...
                        <td width="80%" align="left" class="bd1 pl9" rowspan="3">
                            <f:textarea path="booksynopsis" rows="6" class="w300"/><span
                                class="required">*</span>
                        </td>
                    </tr>
                    <tr class="">
