        ...
        <div class="order02">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <th width="10%" class="bd2">价格</th>
                    <th width="10%" class="bd2">库存</th>
                    <th width="15%" class="bd2">销量</th>
                    <th width="20%" class="bd2">出版社</th>
        ...
        success: function (data) {
            if (data != null) {
                ...
                for (var i = 0; i < data.length; i++) {
                    str += " <tr><td width='15%' class='text'>" + data[i].bookname + "</td>\n" +
                        "     <td width='15%' class='text'>" + data[i].bookauthor + "</td>\n" +
                        "     <td width='10%' class='text'>" + data[i].bookprice + "</td>\n" +
                        "     <td width='10%' class='text'>" + data[i].bookinventory + "</td>\n" +
                        "     <td width='15%' class='text'>" + data[i].booksales + "</td>\n" +
                        "     <td width='20%' class='text'>" + data[i].bookconcern + "</td>\n" +
                        "     <td width='15%' class='text'>\n" +
                        "     <a href='book/editState?bookid=" + data[i].bookid + "&state=1&msg=listBook2'>上架</a>\n" +
                        "     </td></tr>";
                }
                $("#bg").replaceWith(str);
            }
